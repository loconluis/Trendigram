...
var signinBox = yo(_templateObject);
...
//template del formulario
var signupBox = yo(_templateObject);
...
module.exports = {
  message: function message(text, opts) {
    opts = opts || {};
    var msg = new IntlMessageFormat(MESSAGES[locale].likes, locale, null);
